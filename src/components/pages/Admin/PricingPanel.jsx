...
/**
 * The price list, as a panel rather than as a page.
 *
 * It was written inside the pricing screen, which was fine until the owner's
 * controls were gathered into one place: the prices and the rules about how
 * prices may be used are the same decision seen from two sides, and the owner
 * should not have to leave one screen to make the other half of it. So the
 * list lives here and both screens mount it - the desk's own pricing page, and
 * the owner's controllers.
 *
 * Vendors never type a price. Everything they can put on an invoice is a row
 * in here, which is the whole reason the list exists.
 */
